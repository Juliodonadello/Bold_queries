...
CASE 	
			WHEN (FINAL."LEASE_STATUS" = 'VACANT' AND FINAL_AUX."LEASES_COUNT" > 1 AND RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL" > 1) THEN 0
...
CASE   WHEN (FINAL."LEASE_STATUS" = 'VACANT' AND FINAL_AUX."LEASES_COUNT" > 1 AND RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL" > 1) THEN 0
			WHEN SQ_FT_TEMP."TOT_SQ_FT" = 0 THEN 0
			WHEN (FINAL_AUX."LEASES_COUNT"<2 AND RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL" < 2)
