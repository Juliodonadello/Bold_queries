...
CASE 
    WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0
    ELSE FINAL."RENT_CHARGE" * 12 / UNITS."UNIT_SQ_FT" / CASE WHEN COALESCE(RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL", 1) = 0 THEN 1 ELSE RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL" END
