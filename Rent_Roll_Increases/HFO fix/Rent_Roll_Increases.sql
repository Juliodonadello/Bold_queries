...
RENT_SCALATIONS AS (
  SELECT 
	...
	AND (
		...
		-- COMMENTED BECAUSE ON TIME ARE NOT CONSIDER SCALATIONS
		*/
		)
	AND (	
	  	"public"."lease_recurring_charges"."terminate_date" > @AsOfDate
...
CASE 
    WHEN COALESCE(RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL", 1) = 0 THEN FINAL."RENT_CHARGE"
    ELSE FINAL."RENT_CHARGE" / RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL"
END AS "RENT_AMOUNT_fix",
CASE 
    WHEN COALESCE(RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL", 1) = 0 THEN FINAL."OTHER_CHARGE"
    ELSE FINAL."OTHER_CHARGE" / RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL"
END AS "OTHER_AMOUNT_fix",
CASE 
    WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0 
    ELSE FINAL."RENT_CHARGE" * 12 / UNITS."UNIT_SQ_FT" 
END AS "Annual Rent/Sq Ft",
CASE 
    WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0 
    ELSE FINAL."OTHER_CHARGE" * 12 / UNITS."UNIT_SQ_FT" 
END AS "Annual Other/Sq Ft",
CASE 
    WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0
    ELSE FINAL."RENT_CHARGE" * 12 / UNITS."UNIT_SQ_FT" / CASE WHEN COALESCE(RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL", 1) = 0 THEN 1 ELSE COALESCE(RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL", 1) END
END AS "Annual Rent/Sq Ft_fix",
CASE 
    WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0
    ELSE FINAL."OTHER_CHARGE" * 12 / UNITS."UNIT_SQ_FT" / CASE WHEN COALESCE(RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL", 1) = 0 THEN 1 ELSE RENT_SCALATIONS_FINAL."COUNT_RENT_CHARGE_SCAL" END
