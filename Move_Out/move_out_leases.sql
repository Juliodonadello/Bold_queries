...
where ("public"."leases"."deleted_at" is null or "public"."leases"."deleted_at"> @ToDate)
	...
	AND ("public"."leases"."actual_move_out" < @ToDate OR "public"."leases"."intended_move_out" < @ToDate)
	AND ("public"."leases"."actual_move_out" >= @FromDate OR "public"."leases"."intended_move_out" >= @FromDate)
