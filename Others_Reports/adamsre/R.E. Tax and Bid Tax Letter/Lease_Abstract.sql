...
SELECT 
	...
	MAX(CASE WHEN SECOND_AUX."ITEM_ID" = 'R. E. TAX' THEN SECOND_AUX."formatted_date" END) AS "RETAX_formatted_date",
	...
	MAX(CASE WHEN SECOND_AUX."ITEM_ID" = 'TAX BID' THEN SECOND_AUX."formatted_date" END) AS "TAXBID_formatted_date",
