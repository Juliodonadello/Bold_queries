...
RECOVERY_FINAL AS (
  select
    ...
    MAX(CASE WHEN "NAME" = 'R. E. TAX' THEN "manual_percent" END) AS "RETAX_manual_percent",
  	MAX(CASE WHEN "NAME" = 'R. E. TAX' THEN "recovery_from" END) AS "RETAX_recovery_from",
	MAX(CASE WHEN "NAME" = 'R. E. TAX' THEN "recovery_to" END) AS "RETAX_recovery_to"
    /*
...
SELECT 
	...
	MAX(CASE WHEN SECOND_AUX."ITEM_ID" = 'R. E. TAX' THEN RECOVERY_FINAL."RETAX_recovery_from" END) AS "RETAX_recovery_from",
	MAX(CASE WHEN SECOND_AUX."ITEM_ID" = 'R. E. TAX' THEN RECOVERY_FINAL."RETAX_recovery_to" END) AS "RETAX_recovery_to",
	/*
...
WHERE "ROW_NUM" <= 2 and SECOND_AUX."ITEM_ID" = 'R. E. TAX'
GROUP BY
    1,2,3,4,5,6