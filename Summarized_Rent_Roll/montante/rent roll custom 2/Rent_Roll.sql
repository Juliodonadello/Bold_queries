...
CASE 	WHEN SQ_FT_TEMP."TOT_SQ_FT" = 0 THEN 0 
			WHEN (FINAL_AUX."LEASES_COUNT" = 0 OR FINAL_AUX."LEASES_COUNT" IS NULL) THEN ("UNIT_SQ_FT"/ SQ_FT_TEMP."TOT_SQ_FT")
		ELSE ("UNIT_SQ_FT"/FINAL_AUX."LEASES_COUNT") / SQ_FT_TEMP."TOT_SQ_FT"
