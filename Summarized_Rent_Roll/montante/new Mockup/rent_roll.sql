...
CASE WHEN SQ_FT_TEMP."TOT_SQ_FT" = 0 THEN 0 ELSE UNITS."UNIT_SQ_FT" / SQ_FT_TEMP."TOT_SQ_FT" END AS "Pct of Property",
CASE WHEN SQ_FT_TEMP."TOT_SQ_FT" = 0 THEN 0 ELSE ("UNIT_SQ_FT"/FINAL_AUX."LEASES_COUNT") / SQ_FT_TEMP."TOT_SQ_FT" END AS "Pct of Property_fix",
FINAL."DEPOSIT",
FINAL."REFUNDABLE",
--LEASES."RCHARGE_ID",
