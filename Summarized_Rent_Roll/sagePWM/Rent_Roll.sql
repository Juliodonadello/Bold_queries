...
CASE WHEN FINAL."LEASE_STATUS" IS NULL THEN 'VACANT' ELSE FINAL."LEASE_STATUS" END AS "LEASE_STATUS", 
FINAL."TENANT",
...
CASE 	WHEN SQ_FT_TEMP."TOT_SQ_FT" = 0 THEN 0 
		WHEN FINAL."LEASE_STATUS" != 'FUTURE' OR FINAL."LEASE_STATUS" IS NULL  THEN 0 
		ELSE ("UNIT_SQ_FT") / SQ_FT_TEMP."TOT_SQ_FT" * 100 --ELSE ("UNIT_SQ_FT"/FINAL_AUX."LEASES_COUNT") / SQ_FT_TEMP."TOT_SQ_FT" * 100 
	END AS "Fut Pct of Property_fix",
FINAL."DEPOSIT",
FINAL."REFUNDABLE",
FINAL."RENT_AMOUNT" "RENT_AMOUNT",
FINAL."OTHER_AMOUNT" "OTHER_AMOUNT",
CASE WHEN FINAL."LEASE_STATUS" = 'FUTURE' THEN FINAL."RENT_AMOUNT" ELSE 0 END "Fut RENT_AMOUNT",
CASE WHEN FINAL."LEASE_STATUS" = 'FUTURE' THEN FINAL."OTHER_AMOUNT" ELSE 0 END "Fut OTHER_AMOUNT",
FINAL."ANNUAL_RENT_AMOUNT" "ANNUAL_RENT_AMOUNT",
FINAL."ANNUAL_OTHER_AMOUNT" "ANNUAL_OTHER_AMOUNT",
CASE WHEN FINAL."LEASE_STATUS" = 'FUTURE' THEN FINAL."ANNUAL_RENT_AMOUNT" ELSE 0 END "Fut ANNUAL_RENT_AMOUNT",
CASE WHEN FINAL."LEASE_STATUS" = 'FUTURE' THEN FINAL."ANNUAL_OTHER_AMOUNT" ELSE 0 END "Fut ANNUAL_OTHER_AMOUNT",
...
CASE WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0 WHEN FINAL."LEASE_STATUS" = 'FUTURE' THEN 0 ELSE FINAL."RENT_AMOUNT" *12 /UNITS."UNIT_SQ_FT" END AS "Fut Annual Rent/Sq Ft",
CASE WHEN UNITS."UNIT_SQ_FT" = 0 THEN 0 WHEN FINAL."LEASE_STATUS" = 'FUTURE' THEN 0 ELSE FINAL."OTHER_AMOUNT" *12 /UNITS."UNIT_SQ_FT" END AS "Fut Annual Other/Sq Ft"
